...
8. Do not try to use the terminal to edit files just because you don't have the write/edit tool available. That means you are in read-only mode, and it's on purpose.
